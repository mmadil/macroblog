...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tweet'
        db.create_table(u'blog_tweet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')(unique=True, max_length=140)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'blog', ['Tweet'])

        # Adding unique constraint on 'Post', fields ['title']
        db.create_unique(u'blog_post', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Post', fields ['title']
        db.delete_unique(u'blog_post', ['title'])

        # Deleting model 'Tweet'
        db.delete_table(u'blog_tweet')
